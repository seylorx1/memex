...
function Theme (default_theme = { background: '#464646', f_high: '#dcdccc', f_med: '#dca3a3', f_low: '#7f9f7f', f_inv: '#dca3a3', b_high: '#262626', b_med: '#333333', b_low: '#3f3f3f', b_inv: '#8faf9f' }) {
  const themer = this
